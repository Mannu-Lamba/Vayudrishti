...
export default function SatelliteMetadata({ observation, source, channel, details }: SatelliteMetadataProps) {
  ...
  const rows: [string, string | undefined][] = [
    ...
    ["Sub-satellite point", source ? `0.0° / ${formatLongitude(source.subSatelliteLongitude)}` : undefined],
    ...
    ["Scan cadence", source ? `${source.cadenceMinutes} min full disk` : undefined],
